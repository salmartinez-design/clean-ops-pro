...
scripts/phantom-schema-audit.ts:96:    const grepOut = execSync(`grep -rn "generateRecurringJobs\\|recurring_schedule\\|createJobFromSchedule\\|spawnRecurringJob" artifacts/api-server/src lib scripts --include="*.ts" --include="*.js" 2>/dev/null | head -40`, { cwd: "/Users/salvadormartinez/clean-ops-pro", encoding: "utf8" });
