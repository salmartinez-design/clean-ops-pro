    ...
    return (
      <div style={{ fontFamily: "'Plus Jakarta Sans', sans-serif", backgroundColor: '#F7F6F3', minHeight: '100dvh', color: '#1A1917', position: 'relative' }}>
        ...
        <header style={{
          ...
          <button style={{ background: 'none', border: 'none', cursor: 'pointer', color: '#6B7280', padding: '4px', display: 'flex', alignItems: 'center', position: 'relative' }}>
            <Bell size={20} />
            <span style={{
              position: 'absolute', top: 4, right: 4,
              width: 7, height: 7, borderRadius: '50%',
              backgroundColor: 'var(--brand)', border: '2px solid #FFFFFF',
            }} />
          </button>
        </header>
            ...
            return (
              <Link key={tab.href} href={tab.href}>
                <div style={{
                  ...
                  color: isActive ? 'var(--brand)' : '#9E9B94',
                }}>
      ...
      <div style={{ flex: 1, display: 'flex', flexDirection: 'column', overflow: 'hidden', minWidth: 0 }}>
        <header style={{
          ...
          <div style={{ display: 'flex', alignItems: 'center', gap: '12px' }}>
            {user && (
              <>
                <p style={{ fontSize: '13px', fontWeight: 500, color: '#1A1917', margin: 0 }}>
